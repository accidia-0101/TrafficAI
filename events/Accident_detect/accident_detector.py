...
_IMG_SIZE: int = 640
_YOLO_CONF: float = 0.25
_YOLO_IOU: float = 0.50
_DECISION_THRESH: float = 0.3
_DEVICE: int | str = 0
_FP16: bool = True
_LOG_BATCH: bool = True
_LOG_PER_FRAME: bool = False   # 需要时可以开 per-frame debug
...
# from events.bus import AsyncBus, Frame, Detection, topic_for
#
# _MODEL_PATH: str = r"E:\PythonProject\DjangoTrafficAI\train&test\accident_training\yolov8m_accident_fullbbox\weights\best.pt"
# _IMG_SIZE: int = 640
# _YOLO_CONF: float = 0.05
# _YOLO_IOU: float = 0.50
# _DECISION_THRESH: float = 0.45
# _DEVICE: int | str = 0
# _FP16: bool = True
# _LOG_BATCH: bool = True
#
